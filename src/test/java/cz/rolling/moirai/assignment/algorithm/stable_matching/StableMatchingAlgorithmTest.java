...
public class StableMatchingAlgorithmTest {
    ...
    public void testInit2dList() {
        ...
        StableMatchingAlgorithm algorithm = new StableMatchingAlgorithm(createPreferenceResolver(), new StableMatchingProcessorVar1(), 0, 0);
    ...
    public void testTransformPreferences() {
        StableMatchingAlgorithm algorithm = new StableMatchingAlgorithm(createPreferenceResolver(), new StableMatchingProcessorVar1(), 5, 0);
    ...
    public void testFindBestAssignmentMultiSelect() {
        StableMatchingAlgorithm algorithm = new StableMatchingAlgorithm(createPreferenceResolver2(), new StableMatchingProcessorVar1(), 5, 2);
        SolutionHolder solutionHolder = algorithm.findBestAssignment();
        Assert.assertEquals(1, solutionHolder.getSolutions().size());
